...
insert into materias (id, nome, prof, cor) values
  ('age', 'Administração e Gestão Estratégica',      'Prof. Marina Alves',  '#5457C5'),
  ('ext3',   'Extensão Curricular III',          'Prof. Roberto Lima',  '#12897E'),
  ('edados', 'Estrutura de Dados',  'Prof. Carla Souza',   '#C77A0E'),
  ('bd2',    'Banco de Dados II',  'Prof. Daniel Rocha',  '#C13F7A'),
  ('poo1',     'Programação Orientada a Objetos I',      'Prof. Helena Dias',   '#7C4DBB');

-- dia_semana: 1=seg … 5=sex
insert into grade_horaria (materia_id, dia_semana, hora_ini, hora_fim, sala) values
  ('age', 1, '19:00', '20:30', 'Sala 3'),
  ('ext3',   1, '20:50', '22:30', 'Sala 3'),
  ('edados', 2, '19:00', '20:40', 'Lab 2'),
  ('bd2',     2, '20:50', '22:30', 'Lab 2'),
  ('poo1',    3, '19:00', '20:40', 'Sala 5'),
  ('ext3',   4, '19:00', '20:40', 'Sala 3'),
  ('alglin', 4, '20:50', '22:30', 'Sala 3'),
  ('bd2',     5, '19:00', '20:40', 'Lab 1');
...
insert into eventos (tipo, titulo, materia_id, data, hora, observacao) values
  ...
  ('atividade',    'Lista de SQL (vale nota)','bd2',     '2026-07-16', '23:59', null),
  ('cancelamento', 'Aula cancelada',          'bd2',     '2026-07-17', null,    'Professora em congresso'),
